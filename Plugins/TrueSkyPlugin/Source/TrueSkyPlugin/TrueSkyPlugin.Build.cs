...
namespace UnrealBuildTool.Rules
{
	public class TrueSkyPlugin : ModuleRules
	{
		public TrueSkyPlugin(ReadOnlyTargetRules Target) : base(Target)
		{
			...
			// Note: ModuleDir is the Source/TrueSkyPlugin folder.
			...
			if (Target.Platform==UnrealTargetPlatform.Win64)
            {
				...
				string SimulShaderbinDir = System.IO.Path.Combine(ModuleDirectory, "../../shaderbin/Win64");
				RuntimeDependencies.Add(SimulShaderbinDir + "/*.*");
				string SimulTextureDir = System.IO.Path.Combine(ModuleDirectory, "../../textures");
				RuntimeDependencies.Add(SimulTextureDir + "/*.png");
				PrivateDependencyModuleNames.AddRange(new string[] 
				{
					"D3D11RHI", "D3D12RHI"
				});
			...
			else if (Target.Platform==UnrealTargetPlatform.XboxOne)
			{
				...
				string SimulShaderbinDir = System.IO.Path.Combine(ModuleDirectory,"../../shaderbin/XboxOne");
				RuntimeDependencies.Add(SimulShaderbinDir + "/*.*");
				string SimulTextureDir = System.IO.Path.Combine(ModuleDirectory, "../../textures");
				RuntimeDependencies.Add(SimulTextureDir + "/*.png");
			}
			...
			else if(Target.Platform==UnrealTargetPlatform.PS4)
			{
				...
				string SimulShaderbinDir = System.IO.Path.Combine(ModuleDirectory, "../../shaderbin/PS4");
				RuntimeDependencies.Add(SimulShaderbinDir + "/hdr.sfxo");
				RuntimeDependencies.Add(SimulShaderbinDir + "/*.*");
				string SimulTextureDir = System.IO.Path.Combine(ModuleDirectory, "../../textures");
				RuntimeDependencies.Add(SimulTextureDir + "/*.gnf");
			...
			else if(Target.Platform == UnrealTargetPlatform.Switch)
			{
				...
				string SimulShaderbinDir = System.IO.Path.Combine(ModuleDirectory,"../../shaderbin/Switch");
				RuntimeDependencies.Add(SimulShaderbinDir + "/*.*");
				PublicDelayLoadDLLs.AddRange
				(
					new string[] {
